...
?>
	...
	<div class="content back-white">
		<div class="list-view bor_none">
			 <ul class="tuan_ul">
			 	<?php $_from = $this->_var['data']['item']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'youhuiitem');if (count($_from)):
    foreach ($_from AS $this->_var['youhuiitem']):
?>
			 	<li class="tuan_li">
			 	     <a href="<?php
echo parse_url_tag("u:index|youhui#index|"."data_id=".$this->_var['youhuiitem']['id']."".""); 
?>">
			 	     	<div class="list_item">
			 	     		 <div class="pic">
			 	     		 	<img src="<?php echo $this->_var['youhuiitem']['icon']; ?>" width="140" height="85"  />
								<?php if ($this->_var['youhuiitem']['youhui_type'] == 1): ?>
								<i class="tuan_ico order">折扣券</i>
								<?php else: ?>
								<i class="tuan_ico order">满立减</i>
								<?php endif; ?>
			 	     		 </div>
							 <div class="info">
							 	<h2><?php echo $this->_var['youhuiitem']['name']; ?></h2>
								<h3><div> <?php echo $this->_var['youhuiitem']['list_brief']; ?></div></h3>
								<div class="tuan_price">
			                         <p class="time_row">
			                         	 <?php echo $this->_var['youhuiitem']['begin_time']; ?>
									 </p>			                         
									 <p class="bought"><i></i>下载量：<?php echo $this->_var['youhuiitem']['down_count']; ?></p>
			                     </div>
								 <?php if ($this->_var['youhuiitem']['distance']): ?>
								 <div class="distance_row">		
								 	<div>         		                         
									 <i class="iconfont">&#xe611;</i><?php echo $this->_var['youhuiitem']['distance']; ?>
									 </div>	  
			                     </div>
								 <?php endif; ?>
							 </div>
