...
<div class="card_info">
	<div class="f_l">
		<a href="<?php
echo parse_url_tag("u:index|uc_home|"."id=".$this->_var['card_info']['id']."".""); 
?>"><img src="<?php 
$k = array (
...
?>" /></a>
	...
	<div class="f_l" style="padding-left:10px;">
		<a href="<?php
echo parse_url_tag("u:index|uc_home|"."id=".$this->_var['card_info']['id']."".""); 
?>" class="user_name"><?php echo $this->_var['card_info']['user_name']; ?></a>
		...
		<div class="blank"></div>
		<a href="<?php
echo parse_url_tag("u:index|uc_home#uc_fans_list|"."id=".$this->_var['card_info']['id']."".""); 
?>"><?php echo $this->_var['LANG']['FANS']; ?>:<?php echo $this->_var['card_info']['focused_count']; ?></a>
		<a href="<?php
echo parse_url_tag("u:index|uc_home#uc_follow_list|"."id=".$this->_var['card_info']['id']."".""); 
...
?></span>
	...
	<div class="blank5"></div>
	<span class="point_level_span"><?php echo $this->_var['card_info']['point_level']; ?></span>&nbsp;&nbsp;
