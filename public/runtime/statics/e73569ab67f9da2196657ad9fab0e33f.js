...
eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[c.toString(a)]=k[c]||c.toString(a)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(f).d(1(){$(".c .b").a(1(){e(3);$(3).5("2")},1(){h(3);$(3).6("2")});$(".4").j(1(i,4){$(4).8("7 9:g(0)").5("2");$(4).8("7 9").a(1(){$(3).5("2").k().6("2")})})});',21,21,'|function|current|this|get_list|addClass|removeClass|ul|find|li|hover|back|yh_l|ready|show_scan_box|document|eq|hide_scan_box||each|siblings'.split('|'),0,{}))
