...
require_once "api.php";
	...
	header('Content-type: text/xml; charset=utf-8');
		$sql = "SELECT d.id,d.supplier_id,d.discount,c.name as cate_name,d.icon,d.city_id,d.name as goods_name,d.img,d.current_price,d.origin_price,d.begin_time,d.end_time,d.brief as goodsbrief,dc.name as city_name,s.name as supplier_name,d.buy_count,sl.tel as sp_tel,sl.address as sp_address ".
		...
		foreach($list as $item)
		{
			...
			$url = SITE_DOMAIN.url("tuan","deal",array("id"=>$item['id']));	
			...
			$xml.="<site_url>".SITE_DOMAIN.APP_ROOT."</site_url>\r\n";
