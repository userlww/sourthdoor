...
class Zto_express implements express {

	public function get_express_form($order_id,$express_sn)
	{
		$express_module = $GLOBALS['db']->getRow("select * from ".DB_PREFIX."express where class_name = 'Zto'");
