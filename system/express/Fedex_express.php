...
$express_lang = array(
	...
	'sender_zip'	=>	'寄件人邮编',	
	'sender_sign'	=>	'寄件人签名',
	'sender_account'	=>	'寄件人帐号',	
	'app_code'	=>	'查询公司代码',
	'app_code_fedex'	=>	'fedex',
);
$config = array(
	'sender_name'	=>	array(
		'INPUT_TYPE'	=>	'0',
...
class Fedex_express implements express {

	public function get_express_form($order_id,$express_sn)
	{
		$express_module = $GLOBALS['db']->getRow("select * from ".DB_PREFIX."express where class_name = 'Fedex'");
