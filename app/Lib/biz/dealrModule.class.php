...
class dealrModule extends BizBaseModule
{
	...
	{		
	    ...
	    $GLOBALS['tmpl']->assign("ajax_url",url("biz","dealr"));
	    $GLOBALS['tmpl']->assign("form_url",url("biz","dealr#index"));
		$GLOBALS['tmpl']->assign("head_title","消费点评管理");
