...
class storerModule extends BizBaseModule
{
	...
	{		
	    ...
	    $GLOBALS['tmpl']->assign("ajax_url",url("biz","storer"));
	    $GLOBALS['tmpl']->assign("form_url",url("biz","storer#index"));
		$GLOBALS['tmpl']->assign("head_title","门店点评管理");
