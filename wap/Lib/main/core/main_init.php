...
$GLOBALS['tmpl']->template_dir   = APP_ROOT_PATH .FOLDER_NAME.'/Tpl/'.APP_TYPE."/". TMPL_NAME;

//定义模板路径
$tmpl_path = SITE_DOMAIN.APP_ROOT."/".FOLDER_NAME."/Tpl/".APP_TYPE."/";

$GLOBALS['tmpl']->assign("TMPL",$tmpl_path.TMPL_NAME);
$GLOBALS['tmpl']->assign("TMPL_REAL",APP_ROOT_PATH.FOLDER_NAME."/Tpl/".APP_TYPE."/".TMPL_NAME); 
